...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		/// A registered voter can submit a new proposal by providing offchain data string that can be IPFS CID hash that points to a JSON file, a plain text, a small JSON string, or a link to either a static or a dynamic file.
